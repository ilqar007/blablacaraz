...
namespace BlaBlaCarAz.DAL.Migrations
{
    ...
    [Migration("20210205144624_MessageAddColumn")]
    partial class MessageAddColumn
    {
            ...
            modelBuilder.Entity("AppUserMessage", b =>
                {
                    ...
                    b.HasKey("AppUsersId", "MessagesId");
            ...
            modelBuilder.Entity("AppUserMessage", b =>
                {
                    ...
                    b.HasOne("BlaBlaCarAz.BLL.DomainModel.Entities.Message", null)
                        .WithMany()
